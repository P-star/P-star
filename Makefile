...
pkgdatadir = $(datadir)/wpl-compiler
pkgincludedir = $(includedir)/wpl-compiler
pkglibdir = $(libdir)/wpl-compiler
pkglibexecdir = $(libexecdir)/wpl-compiler
...
OTOOL = 
OTOOL64 = 
PACKAGE = wpl-compiler
PACKAGE_BUGREPORT = atle@goliathdns.no
PACKAGE_NAME = WPL compiler
PACKAGE_STRING = WPL compiler 1.0
PACKAGE_TARNAME = wpl-compiler
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
RANLIB = ranlib
